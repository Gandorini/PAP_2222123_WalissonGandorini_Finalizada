...
export default function MusicSheetCard({
  ...
  const handleAddSheetToPlaylists = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      console.log("Partitura adicionada à(s) playlist(s) com sucesso!");
      ...
      console.error('Erro ao adicionar partitura à playlist:', err);
      if (err.code === '23505') {
        setAddPlaylistError('Esta partitura já está em uma das playlists selecionadas.');
      } else {

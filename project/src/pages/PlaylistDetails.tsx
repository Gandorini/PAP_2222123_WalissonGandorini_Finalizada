    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Stack spacing={4}>
        ...
        <Typography variant="h5" component="h2" sx={{ mt: 4, mb: 2 }}>
          Partituras na Playlist
        </Typography>

        {items.length === 0 ? (
          <Alert severity="info">Esta playlist ainda não tem partituras. {isOwner && "Adicione algumas!"}</Alert>
        ) : (
        ...
        >
          <DialogTitle id="remove-item-dialog-title">
            {"Confirmar Remoção de Partitura"}
          </DialogTitle>
          <DialogContent>
            <Typography id="remove-item-dialog-description">
              Tem certeza que deseja remover esta partitura da playlist? Esta ação não removerá a partitura permanentemente da sua biblioteca.
            </Typography>
          </DialogContent>
          <DialogActions>

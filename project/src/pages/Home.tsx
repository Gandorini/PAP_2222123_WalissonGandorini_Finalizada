  ...
  useEffect(() => {
    const fetchFeaturedSheets = async () => {
      ...
      try {
        ...
        setError('Erro ao carregar partituras/cifras. Por favor, tente novamente.');
          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={7}>
              ...
              >
                ...
                >
                  Uma comunidade para músicos aprenderem, partilharem e explorarem novos documentos musicais
                </Typography>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }}>
                ...
                >
                  ...
                  <Typography variant="h3" fontWeight="bold" color="primary">{instrumentCount ?? '...'}</Typography>
